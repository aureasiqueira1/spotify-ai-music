...
// const MONGODB_URI =
//   "mongodb+srv://spotifyuser:efkvnBJtUgbEsujx@cluster0.zhjsqdf.mongodb.net/spotify-ai-music?retryWrites=true&w=majority";
...
//     const method = i === 0 ? 'SRV com DNS' : i === 1 ? 'SRV com SSL' : 'Direct Connection';
...
//       await testCollection.insertOne({ teste: 'funcionou', timestamp: new Date() });
...
//   try {
//     const addresses = await dns.promises.resolve4('cluster0.zhjsqdf.mongodb.net');
...
// // Sua nova senha aqui
// const NOVA_SENHA = "COLE_SUA_SENHA_AQUI";
...
async function testConnections() {
  ...
  try {
    ...
    // Tentar connection string com IP direto
    const directIP = addresses[0];
    const directURI = `mongodb://spotifyuser:efkvnBJtUgbEsujx@${directIP}:27017/spotify-ai-music?ssl=true&authSource=admin`;
